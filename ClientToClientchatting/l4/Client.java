...
public class Client extends javax.swing.JFrame implements Runnable {
    ...
    String gotLine1, gotLine2, remoteIP, remotePort;
    Thread th = null;
    ...
    public Client() throws Exception {
        ...
        while(count < 2){    
            ...
            do{
                ...
                gotLine1 = new String(receivePacket.getData());
            }while(gotLine1 == null);
            strTok = new StringTokenizer(gotLine1);
    ...
    public void run(){
        ...
        while(true){ 
            do{
                ...
                gotLine2 = new String(receivePacket.getData()); 
            }while(gotLine2 == null);
            
//        String matchSocket = receivePacket.getSocketAddress().toString();
        strTok = new StringTokenizer(gotLine2);
        String type = strTok.nextToken();

        if(type.equals("ADD")){
            System.out.println(gotLine2);
            ...
            display.append(gotLine2.substring(4));
        }
    ...
    private void friendListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_friendListMouseClicked
        ...
        System.out.println("TC: " + peer.get(index) + " " + peerAddress.get(peer.get(index))); 
